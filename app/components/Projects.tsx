...
export default function ProjectsAgenda() {
  return (
    <section className="w-full min-h-screen bg-[#F8F6E9] flex items-center px-10 py-20 relative">
      ...
      <div className="ml-32 flex flex-col gap-10 w-full max-w-4xl">
        ...
        {/* BOOK 1 — Works */}
        <div className="bg-[#5B4140] text-white rounded-xl px-14 py-10 shadow-md relative w-[90%]">
        ...
        <div className="bg-[#EFC2C8] text-[#3E3E4A] rounded-xl px-14 py-10 shadow-md w-[75%]">
        ...
        <div className="bg-[#C98651] text-white rounded-xl px-14 py-10 shadow-md relative flex w-[85%]">
          {/* Decorative bold spine stripes */}
          <div className="absolute left-8 top-4 bottom-4 w-2 bg-[#4E3B2D] rounded-full"></div>
          <div className="absolute left-165 top-4 bottom-4 w-2 bg-[#4E3B2D] rounded-full"></div>
        ...
        {/* BOOK 4 — Name */}
        <div className="bg-[#894C43] text-white rounded-xl px-14 py-10 shadow-md w-[80%]">
